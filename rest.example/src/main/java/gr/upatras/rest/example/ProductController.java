...
public class ProductController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 402, message = "Payment Required", response = Error.class),
    ...
    public ResponseEntity<Void> deleteById(@ApiParam(value = "Identifier of the Category", required = true)  @PathVariable("id") int id) {
        try {
...
ResponseEntity<Product> patchProduct(@ApiParam(value = "The Product to be updated", required = true) @RequestBody Product body, @ApiParam(value = "Identifier of the Product", required = true) @PathVariable("id") String id) {
